...
sedan.GetSystem().Add(ball_merge_right)
...
sedan.GetSystem().Add(ball_merge_left)
...
sedan.GetSystem().Add(ball_paral_right)
...
sedan.GetSystem().Add(ball_paral_left)
...
sedan.GetSystem().Add(ball_serial)
# -------------------------------------
